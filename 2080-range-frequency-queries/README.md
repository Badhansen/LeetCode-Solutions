<h2><a href="https://leetcode.com/problems/range-frequency-queries/">2080. Range Frequency Queries</a></h2><h3>Medium</h3><hr><div><p>Design a data structure to find the <strong>frequency</strong> of a given value in a given subarray.</p>
