<h2><a href="https://leetcode.com/problems/design-sql/">2408. Design SQL</a></h2><h3>Medium</h3><hr><div><p>You are given two string arrays, <code>names</code> and <code>columns</code>, both of size <code>n</code>. The <code>i<sup>th</sup></code> table is represented by the name <code>names[i]</code> and contains <code>columns[i]</code> number of columns.</p>
